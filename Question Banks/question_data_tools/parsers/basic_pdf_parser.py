"""
Basic PDF to Questions Parser
Extracts questions from PDF files with basic parsing logic.
"""
...
class BasicPDFParser(BaseParser):
    """
    Basic PDF parser with simple question extraction logic.
    """
    
    def parse_questions(self, text):
        """
        Parse questions from text using basic pattern matching.
...
def main():
    """
    Main function to run the basic PDF parser.
    """
